...
Run the equivalence harness over all 5 motive corpora. Inspect diff output. Confirm zero divergence lines. Re-run after any fold change to detect regressions.
