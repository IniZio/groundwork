...
- **Verification**: unverified — backing tests in `test/hooks/checkpoint.test.ts` and `test/hooks/guard-parity.test.ts`; `// @verifies` annotation pending test-file update.
- **Criticality**: must
