...
Decisions recorded without alternatives leave no evidence that options were considered; id collisions without explicit supersession marks make the decision log ambiguous and hard to audit. Both are quality gaps detectable at session-end without blocking completion.
