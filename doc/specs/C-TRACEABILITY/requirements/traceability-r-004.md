...
Nondeterministic output makes it impossible to diff two regenerations and detect what changed. It also means two viewers of the same motive may see different graphs, breaking the "same input yields same output" contract required by AC-4.
