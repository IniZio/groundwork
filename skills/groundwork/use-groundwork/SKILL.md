...
<!-- SUBAGENT-STOP: If you are a subagent (coder, designer, debugger, planner, etc.) — STOP. Do not read further. This skill contains orchestrator-only rules that will confuse your executor role. -->
