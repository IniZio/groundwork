...
- **Verification**: manual — Review the D-8 reconciliation table against `VALID_TYPES`. Run the enumeration check asserting every type appears exactly once in the role table.
- **Criticality**: must
