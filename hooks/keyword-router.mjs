...
const ROUTES = [
  ...
  },
  {
    ...
    hint: 'Route to `groundwork:planner` first. Planner MUST create or update a motive charter (`.groundwork/motives/<slug>/motive.md`) with DECISION events and report it as `motive_ref` to the orchestrator BEFORE any fan-out — never fan out from a memory-only plan. Then `vertical-slice` + `groundwork:general-purpose`.',
  },
  {
