...
- **Verification**: unverified — Automated — the sweep routine checks the footer before any `rmSync` call; a regression test asserts that a hand-authored file survives the sweep.
- **Criticality**: must
