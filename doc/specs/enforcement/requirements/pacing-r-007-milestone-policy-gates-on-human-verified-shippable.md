...
- **Verification**: unverified — covered by tests in S7's test suite (milestone enforcement). S6 (this spec) is design-only; the fit criterion is not testable until S7 lands.
- **Criticality**: must
