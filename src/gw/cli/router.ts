...
import { HOOKS_SUBCOMMANDS } from './commands/hooks.js'
...
export const COMMANDS: Record<string, { summary: string }> = {
  ...
  hooks: { summary: 'Install/uninstall/status groundwork commit-msg hook' },
}
...
export function helpText(): string {
  ...
  lines.push('')
  lines.push('Hooks subcommands (via gw hooks <subcmd>):')
  lines.push(`  ${HOOKS_SUBCOMMANDS.join(', ')}`)
  lines.push('')
  lines.push('Flags:')
