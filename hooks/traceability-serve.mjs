...
import { NativeSpineAdapter } from './lib/traceability-adapter.mjs'
...
if (isMain) {
  ...
  if (flags.help || flags.h) {
    process.stdout.write(
      'Usage: node hooks/traceability-serve.mjs <slug> [--port N]\n' +
      '\n' +
      'Options:\n' +
  ...
  if (!slug) die('slug is required.\nUsage: node hooks/traceability-serve.mjs <slug> [--port N]', 2)
